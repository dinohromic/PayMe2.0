...
public class DetailDebtUpdaterTest {
    ...
    public void init(){
        ...
        this.group = Factory.createGroup("testGroup", new ArrayList<>(), 0);
        ...
        this.event = new Event("Test", this.debtMap, user3, new DetailedCreateDebtList(), "", 0);
    ...
    public void testUser3GotPositiveToUser1(){
        Map<Member, Integer> debtMapUser3 = debtCalculator.calcMemberSpecificDebt(group.getGroupMembers(), this.user3, group.getDebtHandler());
    ...
    /* Test debt from user2 to user3 */
     ...
     public void testUser2GotNegativeDebtToUser3(){
         Map<Member, Integer> debtMapUser2 = debtCalculator.calcMemberSpecificDebt(group.getGroupMembers(), this.user2, group.getDebtHandler());
     ...
     public void testUser1GotNegativeDebtToUser3(){
         Map<Member, Integer> debtMapUser1 = debtCalculator.calcMemberSpecificDebt(group.getGroupMembers(), this.user1, group.getDebtHandler());
